...
class TestUtilities(TestCase):
    ...
    def test_simulate_elevator_multiple_floors(self) -> None:
    ...
    def test_simulate_elevator_with_start_floor(self) -> None:
    ...
    def test_simulate_elevator_repeated_floors(self) -> None:
    ...
    def test_simulate_elevator_negative_floors(self) -> None:
    ...
    def test_simulate_elevator_negative_start_floor(self) -> None:
    ...
    def test_simulate_elevator_zero_start_floor(self) -> None:
    ...
    def test_simulate_elevator_negative_and_zero_floors(self) -> None:
    ...
    def test_simulate_elevator_all_same_negative_start(self) -> None:
    ...
    def test_simulate_elevator_empty_with_negative_start(self) -> None:
